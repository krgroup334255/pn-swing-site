...
const SEATS = [
  ["P.001","Perlis","PN","PAS",27.63,86.01,8.14,0.88],
  ["P.002","Perlis","PN","Bersatu",16.36,81.58,14.73,1.57],
  ["P.003","Perlis","PN","PAS",49.62,87.23,7.81,1.59],
  ["P.004","Kedah","PN","Bersatu",28.47,89.65,6.75,2.38],
  ...
  ["P.010","Kedah","PN","PAS",27.93,75.96,22.25,1.18],
  ["P.011","Kedah","PN","PAS",41.39,88.47,4.75,0.50],
  ["P.012","Kedah","PN","PAS",40.33,80.43,13.03,6.01],
  ["P.013","Kedah","PN","PAS",42.59,92.50,1.46,0.14],
  ["P.014","Kedah","PN","Bersatu",20.50,69.06,15.30,14.41],
  ["P.015","Kedah","PH","PKR",0.86,60.99,25.75,12.45],
  ["P.016","Kedah","PN","PAS",26.72,89.24,4.27,4.63],
  ["P.017","Kedah","PN","Bersatu",17.79,62.18,17.75,19.36],
  ...
  ["P.026","Kelantan","PN","Bersatu",36.76,96.60,1.91,0.08],
  ["P.027","Kelantan","PN","Bersatu",63.84,94.32,4.11,0.49],
  ["P.028","Kelantan","PN","PAS",35.80,98.04,0.89,0.04],
  ["P.029","Kelantan","PN","Bersatu",15.59,96.34,3.09,0.16],
  ["P.030","Kelantan","PN","Bersatu",29.02,97.72,0.18,0.12],
  ...
  ["P.036","Terengganu","PN","PAS",42.37,90.23,8.65,0.55],
  ["P.037","Terengganu","PN","PAS",38.26,97.53,1.87,0.08],
  ["P.038","Terengganu","PN","Bersatu",21.85,98.82,0.43,0.04],
  ["P.039","Terengganu","PN","PAS",37.37,95.71,3.16,0.19],
  ["P.040","Terengganu","PN","PAS",24.03,93.17,5.06,0.53],
  ["P.041","P. Pinang","PN","PAS",4.14,79.90,15.50,4.17],
  ["P.042","P. Pinang","PN","Bersatu",18.26,77.93,15.08,6.35],
  ["P.043","P. Pinang","PH","DAP",72.32,14.51,69.32,15.63],
  ["P.044","P. Pinang","PN","PAS",6.03,73.12,19.46,6.60],
  ...
  ["P.057","Perak","PN","PAS",10.20,68.43,25.88,5.10],
  ...
  ["P.073","Perak","PN","PAS",8.77,80.97,12.21,3.26],
  ...
  ["P.136","Melaka","PN","PAS",9.62,69.28,22.29,3.65],
  ["P.137","Melaka","PH","DAP",9.14,61.73,30.62,6.04],
  ["P.138","Melaka","PH","DAP",37.68,38.98,54.17,4.46],
  ["P.139","Melaka","PN","PAS",0.41,73.29,15.50,10.12],
  ...
  ["P.154","Johor","PN","Bersatu",4.98,81.18,13.74,1.18],
  ...
  ["P.166","WP Labuan","PN","Bersatu",6.30,76.20,15.30,2.10],
  ...
  ["P.205","Sarawak","PN","Bersatu",28.62,36.90,6.64,0.03],
