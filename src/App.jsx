...
export default function App(){
  ...
  const dunChart=Object.entries(dn.states).map(([st,v])=>({name:st.replace("P. Pinang","P.Pinang").replace("N. Sembilan","N.Semb"),orig:v.o,flip:v.f,total:v.t,maj:v.m,other:v.t-v.o-v.f,fg:v.g,gps:!!v.gps})).sort((a,b)=>a.gps-b.gps||(b.orig+b.flip)/b.total-(a.orig+a.flip)/a.total);
